---
title: |
      <span style = 'font-size: 70%;'> <span style="color:white"> Observational Studies for Impact Evaluation using R </span>
       
subtitle: |
          <span style = 'font-size: 60%;'> Stellenbosch University 

author: |
   <span style = 'font-size: 80%;'><span style="color:#B00020"> Yebelay Berehan </span> 
   
  
institute: |
           <span style = 'font-size: 50%;'> October 25, 2021</span>
...
xaringanExtra::use_logo(image_url = "Image/logo.png", width = "95px",height = "95px")
```
...
knitr::include_graphics("Image/fig9.png")
```
...
plot(c(0, 1), c(6, 8), type = "p", ylim = c(5, 12), xlim = c(-0.3, 1.3),
main = "treatment group", xlab = "Period", ylab = "Y", col = "steelblue", pch = 19, xaxt = "n", yaxt = "n")
axis(1, at = c(0, 1), labels = c("before", "after"))
axis(2, at = c(0, 13))

# add treatment group
points(c(0,  1), c(7, 11), col = "darkred",pch = 19)
```
]
--
.pull-right[
...
# initialize plot and add control group
plot(c(0, 1), c(6, 8), type = "p", ylim = c(5, 12), xlim = c(-0.3, 1.3),
main = "The Differences-in-Differences Estimator", xlab = "Period", ylab = "Y", col = "steelblue", pch = 19, xaxt = "n", yaxt = "n")
axis(1, at = c(0, 1), labels = c("before", "after"))
axis(2, at = c(0, 13))

# add treatment group
points(c(0, 1, 1), c(7, 9, 11), col = "darkred",pch = 19)
...
# text(0, 5.5, "mean control", cex = 0.8 , pos = 4)
# text(0, 6.8, "mean treatment", cex = 0.8 , pos = 4)
# text(1, 7.9, "mean control", cex = 0.8 , pos = 4)
# text(1, 11.1, "mean treatment", cex = 0.8 , pos = 4)
```
]

```{r, out.width='60%', fig.align='left', echo=FALSE}
knitr::include_graphics("Image/fig_4.png")
```
...
```{r, message=FALSE, warning=F, eval=FALSE}
...
knitr::include_graphics("Image/fig10.png")
```
]
.pull-right[
- **At Post Intervention**
```{r, out.width='60%', fig.align='center', echo=FALSE}
knitr::include_graphics("Image/fig11.png")
```
]
