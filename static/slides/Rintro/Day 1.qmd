---
title: |
       <span style="color:white"> <span style = 'font-size: 170%;'>Introduction to R and RStudio</span>
author: 
  - <span style='color:red'>Yebelay Berehan</span>
...
-   It is flexible enough to be used to create **interactive web pages** (eg. [my draft website](https://yebelay.rbind.io)) and **automated reports**.
...
![](img/cran_select_windows.png){fig-align="center"}

2.  Choose the "base" sub-directory.

![](img/install_r_windows_base.png){fig-align="center"}
...
4.  After the download is finished, click on the downloaded file, then follow the instructions on the installation pop-up window. 
...
To download RStudio, go to [posit.co/download/rstudio-desktop](https://posit.co/download/rstudio-desktop/) and download the Windows version.

![](img/install_rstudio_button_windows.png){width="451" height="250" fig-align="center"}
...
![](img/RStudio1.png){height="550" fig-align="center"}
...
![](images/new_r_script.jpg){width="451" height="91" fig-align="center"}
...
![](images/rstudio_pane_layout.png){width="851" height="310" fig-align="center"}
...
![](images/rstudio_pop_out_icon.png){width="329" fig-align="center"}
...
![](images/rstudio_console.png){width="594" fig-align="center"}
...
![](images/environment_tab.png){width="527" fig-align="center"}
...
![](images/rstudio_explore_object_dropdown.png){width="351" fig-align="center"}
...
![](images/broom_icon.png){fig-align="center"}
...
![](images/history_tab.png){width="470" fig-align="center"}
...
![](images/rstudio_files.png){fig-align="center"}
...
![](images/rstudio_plots.png){fig-align="center"}
...
![](images/packages_tab.png){width="419" height="250" fig-align="center"}
...
![](images/example_help_page.png){width="451" fig-align="center"}
...
![](images/rstudio_themes.png){width="530" fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](images/options_highlight_function_rainbow_parentheses.jpg){width="446" height="350" fig-align="center"}
::: 
::: {.column width="50%"}
![](images/highlight_r_function_calls.jpg){width="560" height="166" fig-align="center"}
:::
::: 

## RStudio options

![](images/rainbow_parentheses.jpg){width="361" fig-align="center"}
...
![](images/command_palette.jpg){width="527" fig-align="center"}
...
![](images/rstudio_cheatsheet.png){width="1250" height="550" fig-align="center"}
...
![](images/data_import.jpg){fig-align="center"}
