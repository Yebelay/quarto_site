...
title-slide-attributes:
  data-background-image: datviz.png #fullimge.jpg
...
![](install_rstudio_button_windows.png){width="400"}
...
::: columns
::: {.column width="50%"}
![](open_rstudio_windows.png){width="250"}
:::

::: {.column width="50%"}
![](first_open.png){width="1220"}
:::
:::
